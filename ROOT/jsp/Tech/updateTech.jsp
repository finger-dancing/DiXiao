...
<html>
  <head>
    ...
    <title>My JSP 'updateTech.jsp' starting page</title>
  ...
  <body>
    <form action="tech/updateTech" method="post">
    	技术ID：<input type="text" name="id"/><br/>
    	技术名称：<input type="text" name="name"/><br/>
    	技术类别：<input type="text" name="tid"/><br/>
    	技术介绍：<input type="text" name="introduction"/><br/>
