...
$(document).on("click",".tabli",function(){
  ...
  if($(this).parent().hasClass("abouts")){
...
function renderAllItem(tag,res){
    ...
    if(res.picture){
      pic+='<img  class="newsimg" src="'+XHR.SERVICES_URL+res.picture+'" alt=" " />';
    }
	/*
    if(res.video){
      vi+='<div class="video"><video src="'+XHR.SERVICES_URL+res.video+'" controls="controls"></video></div>';
    }*/
